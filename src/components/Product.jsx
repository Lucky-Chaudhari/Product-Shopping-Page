...
const Product = ({post}) => {
  ...
  return(
   ...
   hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] gap-3 mt-10
    p-4 ml-5 rounded-xl ">
      <div className="">
     <p className="text-gray-700 font-semibold text-lg text-left truncate w-40 mt-1">{post.title}</p>
      </div>
     <div>
     <p className="w-40 text-black font-normal text-[11px] text-left">{post.description.split(" ").slice(0,10).join(" ")+"..."}</p>
     </div>
     <div className="h-[180px]">
